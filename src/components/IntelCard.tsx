...
export function IntelCard({
  ...
  return (
    <DraggablePanel
      ariaLabel="Country dossier"
      className={`intel-card ${open ? "open" : ""}`}
      hidden={!open}
      initialPosition={{ x: 870, y: 112 }}
      panelId="country-dossier"
      role="region"
    >
          ...
          <>
            ...
            <div className="intel-grid">
              ...
              <div className="intel-cell">
                ...
                <p className="stat-value">{formatCompactNumber(country.area)} km2</p>
              </div>
              <div className="intel-cell">
                <p className="stat-label">Density</p>
                <p className="stat-value">{formatNumber(country.density)}/km2</p>
              </div>
              <div className="intel-cell">
